 ...
 * output to {@link Writer Writers}. <h3>Standards compliance</h3> This class is intended to produce
 * output that conforms to the
 ...
 * <ul>
 * <li>the name of the applicable encoding is always printed in the XML declaration, even though it
 * may not be necessary;</li>
 * <li>the <code>standalone</code> attribute is not supported in the XML declaration;</li>
 * <li>internal DTD subsets are not supported;</li>
 * <li>the strategy for inserting spacing is fixed: whitespace is kept to the minimum, still
 * whitespace can be inserted manually using {@link #whitespace(String)};</li>
 * <li>XML Namespaces are not explicitly supported, although this can be implemented on top of this
 * class.</li>
 * </ul>
 * <h3>Supported encodings</h3> The following encodings are supported:
 * <ul>
 * <li>UTF-8</li>
 * <li>UTF-16</li>
 ...
 * </ul>
 * <h3>Multi-threading</h3> This class is <em>not</em> thread-safe. Do not use it from multiple
 * threads at the same time.
 * <h3>Exceptions</h3> Note that all methods check the state first and then check the arguments.
 * This means that if the state is incorrect and the arguments are incorrect, then an
 * {@link IllegalStateException} will be thrown.
 * <p />
 * If any of the writing methods generates an {@link IOException}, then the state will be set to
 * {@link #ERROR_STATE} and no more output can be performed.
 * <h3>Performance hints</h3> It is usually a good idea to let <code>XMLOutputter</code> instances
 * write to buffered {@link Writer Writers}. This typically improves performance on large documents
...
public class XMLOutputter extends Object implements StatefulXMLEventListener {
    ...
    /**
     * Constructs a new <code>XMLOutputter</code>. This sets the state to {@link #UNINITIALIZED}.
     */
    public XMLOutputter() {
     ...
     * <p />
     * The value of this field is returned by {@link #getWriter()}.
     */
    private Writer _out;
    ...
    /**
     * The size of the element stack. The actual capacity is {@link #_elementStack}
     * <code>.length</code>.
     */
     ...
     * <p />
     * The value of this field can be set using {@link #setQuotationMark(char)} and can be retrieved
    ...
    /**
     * The line break that is currently in use. Should never become <code>null</code>.
     */
    ...
    /**
     * The currently used indentation string. Can never become <code>null</code>.
     */
     ...
     * this method.
     * <p />
     * Calling this method with {@link #UNINITIALIZED} as the state is equivalent to calling
     * {@link #reset()}.
     * <p />
    ...
    public final void setState(XMLEventListenerState newState, String[] newElementStack) throws IllegalArgumentException {
        ...
        } else if (newState == XMLEventListenerStates.START_TAG_OPEN && newElementStack == null) {
            throw new IllegalArgumentException("newState == START_TAG_OPEN && newElementStack == null");
        } else if (newState == XMLEventListenerStates.WITHIN_ELEMENT && newElementStack == null) {
            throw new IllegalArgumentException("newState == WITHIN_ELEMENT && newElementStack == null");
        } else if (newState != XMLEventListenerStates.START_TAG_OPEN && newState != XMLEventListenerStates.WITHIN_ELEMENT && newElementStack != null) {
    ...
    public final void setLineBreak(LineBreak lineBreak) {
        ...
        _lineBreak = lineBreak != null ? lineBreak : LineBreak.NONE;
    ...
    public final void setIndentation(String indentation) throws IllegalStateException {
        ...
        indentation = indentation != null ? indentation : DEFAULT_INDENTATION;
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (ch != ' ' && ch != '\t') {
                String message = "indentation.charAt(" + i + ") = " + (int) ch + ", while only space and tab are allowed.";
     ...
     * <p />
     * An external subset can be specified using either a <em>system identifier</em> (alone), or
     * using both a <em>public identifier</em> and a <em>system identifier</em>. It can never be
     * specified using a <em>public identifier</em> alone.
     * <p />
     * For example, for XHTML 1.0 the public identifier is: <blockquote>
     * <code>-//W3C//DTD XHTML 1.0 Transitional//EN</code></blockquote>
     * <p />
     * while the system identifier is: <blockquote>
     * <code>http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd</code></blockquote>
     * <p />
     * The output is typically similar to this: <blockquote>
     * <code>&lt;!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"&gt;</code>
     * </blockquote> or alternatively, if only the <em>system identifier</em> is specified:
     * <blockquote>
    ...
    public final void dtd(String name, String publicID, String systemID) throws IllegalStateException, IllegalArgumentException, InvalidXMLException, IOException {
        ...
        // Check state
        if (_state != XMLEventListenerStates.BEFORE_XML_DECLARATION && _state != XMLEventListenerStates.BEFORE_DTD_DECLARATION) {
            throw new IllegalStateException("getState() == " + _state);
        }
    ...
    /**
     * Adds an attribute to the current element, with a <code>String</code> value. There must
    ...
    /**
     * Adds an attribute to the current element, with a <code>boolean</code> value. There must
     * currently be an open element.
     * <p />
     * The attribute value is surrounded by the quotation mark character (see
     * {@link #getQuotationMark()}).
    ...
    /**
     * Adds an attribute to the current element, with a <code>byte</code> value. There must
     * currently be an open element.
     * <p />
     * The attribute value is surrounded by the quotation mark character (see
     * {@link #getQuotationMark()}).
    ...
    /**
     * Adds an attribute to the current element, with a <code>short</code> value. There must
     * currently be an open element.
     * <p />
     * The attribute value is surrounded by the quotation mark character (see
     * {@link #getQuotationMark()}).
    ...
    /**
     * Adds an attribute to the current element, with an <code>int</code> value. There must
     * currently be an open element.
     * <p />
     * The attribute value is surrounded by the quotation mark character (see
     * {@link #getQuotationMark()}).
    ...
    /**
     * Adds an attribute to the current element, with a <code>long</code> value. There must
     * currently be an open element.
     * <p />
     * The attribute value is surrounded by the quotation mark character (see
     * {@link #getQuotationMark()}).
    ...
    /**
     * Adds an attribute to the current element, with a <code>float</code> value. There must
     * currently be an open element.
     * <p />
     * The attribute value is surrounded by the quotation mark character (see
     * {@link #getQuotationMark()}).
    ...
    /**
     * Adds an attribute to the current element, with a <code>double</code> value. There must
     * currently be an open element.
     * <p />
     * The attribute value is surrounded by the quotation mark character (see
     * {@link #getQuotationMark()}).
    ...
    /**
     * Adds an attribute to the current element, with a <code>char</code> value. There must
     * currently be an open element.
     * <p />
     * The attribute value is surrounded by the quotation mark character (see
     * {@link #getQuotationMark()}).
    ...
    public final void endTag() throws IllegalStateException, IOException {
        ...
        // Check state
        if (_state != XMLEventListenerStates.WITHIN_ELEMENT && _state != XMLEventListenerStates.START_TAG_OPEN) {
            throw new IllegalStateException("getState() == " + _state);
        }
    ...
    /**
     * Writes the specified comment. The comment should not contain the string <code>"--"</code>.
     * <p />
     * If the state equals {@link #BEFORE_XML_DECLARATION}, then it will be set to
     * {@link #BEFORE_DTD_DECLARATION}, otherwise if the state is {@link #START_TAG_OPEN} then it
     * will be set to {@link #WITHIN_ELEMENT}, otherwise the state will not be changed.
     ...
     * should be specified.
     * <p />
     * A processing instruction can appear above and below the root element, and between elements.
     * It cannot appear inside an element start or end tag, nor inside a comment. Processing
     * instructions cannot be nested.
     * <p />
     * If the state equals {@link #BEFORE_XML_DECLARATION}, then it will be set to
     ...
     * <p />
     * A CDATA section can contain any string, except <code>"]]&gt;"</code>. This will, however, not
     * be checked by this method.
     * <p />
     * Left angle brackets and ampersands will be output in their literal form; they need not (and
     * cannot) be escaped using <code>"&amp;lt;"</code> and <code>"&amp;amp;"</code>.
     * <p />
     * If the specified string is empty (i.e. <code>"".equals(text)</code>, then nothing will be
     * output.
     * <p />
    ...
    /**
     * Closes all open elements. After calling this method, only the {@link #whitespace(String)}
    ...
    public final void close() throws IllegalStateException, IOException {
        ...
        // Check state
        if (_state != XMLEventListenerStates.START_TAG_OPEN && _state != XMLEventListenerStates.WITHIN_ELEMENT && _state != XMLEventListenerStates.AFTER_ROOT_ELEMENT) {
            throw new IllegalStateException("getState() == " + _state);
        }
     ...
     * underlying output stream will be flushed using {@link #getWriter()}.
     * {@link java.io.Writer#flush() flush()}.
     * <p />
